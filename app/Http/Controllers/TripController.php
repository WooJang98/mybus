...
class TripController
{
    ...
    public function trip_select(Request $request)
    {
        ...
        ->select('car_id','departure_time', 'arrival_time', 'driver.driver_name', 'dtg_status', DB::raw('CAST(driving_time AS CHAR) AS driving_time'), 'driving_distance', 'speed_max', 'speed_avg', 'rpm_max', 'rpm_avg', 'volt_min', 'volt_max', 'overspeed_time', 'accumulated_distance')
        ->get();
